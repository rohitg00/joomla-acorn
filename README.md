...
- **Containers**: These containers will be deployed for running Joomla. We have two containers, one for Joomla and the other for Mariadb. We are setting the environment variables returned from the MariaDB Acorn service for the Joomla container.
...
3. Choose the source for deploying your Acorns
  ...
  * Provide any random name such as `web-app` and keeping Project's default Region, type in the below Acorn image and choose Create 
    ```bash
    ghcr.io/rohitg00/joomla:latest
    ```
